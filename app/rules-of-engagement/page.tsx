    ...
    <main className="flex-grow bg-[#0c0d0f] text-slate-100 min-h-screen font-mono flex flex-col justify-between py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto w-full relative z-10 space-y-8">
        ...
        <div className="space-y-6 pt-2">
          ...
          {/* RULE 1: FAIR PLAY */}
          <div className="border border-[#1e293b]/80 bg-[#0e1013]/60 p-6 rounded-xl space-y-3 hover:border-[#3B82F6]/20 transition-colors duration-200">
            <h2 className="text-xs font-black tracking-widest text-[#3B82F6] uppercase">
            ...
            <div className="space-y-2 font-sans text-xs text-slate-300 leading-relaxed">
              ...
              <p className="font-mono text-[11px] text-[#3B82F6]/90 bg-[#3B82F6]/[0.02] border border-[#3B82F6]/10 p-2.5 rounded">
          ...
          <div className="border border-[#1e293b]/80 bg-[#0e1013]/60 p-6 rounded-xl space-y-3 hover:border-[#3B82F6]/20 transition-colors duration-200">
            ...
            <div className="space-y-2 font-mono text-[11px] text-slate-300 leading-relaxed">
              ...
              <div className="bg-amber-500/[0.02] border border-amber-500/10 p-3 rounded text-amber-400 font-bold uppercase tracking-wider text-[10px]">
