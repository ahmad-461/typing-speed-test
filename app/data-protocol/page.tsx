    ...
    <main className="flex-grow bg-[#0c0d0f] text-slate-100 min-h-screen font-mono flex flex-col justify-between py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto w-full relative z-10 space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-450 font-sans leading-relaxed max-w-2xl">
        ...
        <div className="space-y-6">
          ...
          <div className="border border-[#1e293b] bg-[#0e1013]/80 p-4 sm:p-6 rounded-xl space-y-3 relative overflow-hidden group card-hover-lift">
            ...
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-slate-450 tracking-wider flex items-center gap-1.5 font-mono uppercase">
            ...
            <div className="space-y-2 font-sans text-xs text-slate-300 leading-relaxed">
              ...
              <div className="bg-[#090A0C] border border-slate-800/40 p-3 rounded-lg font-mono text-[11px] text-slate-450 space-y-1">
          ...
          <div className="border border-[#1e293b] bg-[#0e1013]/80 p-4 sm:p-6 rounded-xl space-y-3 relative overflow-hidden group card-hover-lift">
            <div className="absolute top-0 left-0 w-1 h-full bg-[#3B82F6]" />
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-slate-455 tracking-wider flex items-center gap-1.5 font-mono uppercase">
                <span className="text-[#3B82F6]">[02]</span> [REMOTE_DB_STORAGE]
              </span>
              <span className="text-[10px] text-sky-400 bg-sky-500/[0.04] border border-sky-500/20 px-2 py-0.5 rounded-lg uppercase font-black tracking-wider font-mono">
                On-Demand Submit
              </span>
            </div>
          ...
          <div className="border border-[#1e293b] bg-[#0e1013]/80 p-4 sm:p-6 rounded-xl space-y-3 relative overflow-hidden group card-hover-lift">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 pt-1">
              <div className="bg-[#090A0C] border border-slate-800/60 p-3 rounded-lg text-center">
                <span className="text-[10px] text-rose-400 font-bold block uppercase mb-1 font-mono">COOKIES</span>
                <span className="text-[11px] text-slate-450">0 Third-Party Cookies</span>
              </div>
              <div className="bg-[#090A0C] border border-slate-800/60 p-3 rounded-lg text-center">
                <span className="text-[10px] text-rose-400 font-bold block uppercase mb-1 font-mono">ANALYTICS</span>
                <span className="text-[11px] text-slate-450">No trackers or pixels</span>
              </div>
              <div className="bg-[#090A0C] border border-slate-800/60 p-3 rounded-lg text-center">
                <span className="text-[10px] text-rose-400 font-bold block uppercase mb-1 font-mono">ADVERTISING</span>
                <span className="text-[11px] text-slate-450">Zero ad network scripts</span>
              </div>
            </div>
          </div>
          ...
          <div className="border border-[#1e293b] bg-[#0e1013]/80 p-4 sm:p-6 rounded-xl space-y-3 relative overflow-hidden group card-hover-lift">
            ...
            <div className="space-y-2 font-sans text-xs text-slate-300 leading-relaxed">
              ...
              <div className="bg-[#090A0C] border border-slate-800/40 p-3 rounded-lg font-mono text-[11px] text-slate-450 space-y-2">
                <div>
          ...
          {/* 5. DATA MANAGEMENT */}
          <div className="border border-red-500/25 bg-red-950/[0.02] p-4 sm:p-6 rounded-xl space-y-4 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-1 h-full bg-red-500" />
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-red-400 tracking-wider flex items-center gap-1.5 font-mono uppercase">
                <span>[05]</span> [LOCAL_DATA_DESTRUCTION]
              </span>
              <span className="text-[10px] text-red-400 bg-red-500/[0.04] border border-red-500/20 px-2 py-0.5 rounded-lg uppercase font-black tracking-wider font-mono">
                Wipe Tool
              </span>
            </div>
            ...
            <div className="font-sans text-xs text-slate-300 space-y-2 leading-relaxed">
              ...
              <p className="text-rose-450/90 font-medium">
            ...
            <div className="pt-2">
              {!showConfirm ? (
                <button
                  ...
                  className="py-2.5 px-4 rounded-xl text-xs font-mono font-bold uppercase tracking-wider transition-all duration-150 border border-red-500/30 bg-red-950/20 text-red-400 hover:bg-red-900/30 hover:text-red-300 cursor-pointer min-h-[44px] active:scale-[0.97]"
                >
                  &gt; initiate_data_purge.sh
                </button>
              ) : (
                <div className="bg-[#090a0c] border border-red-500/30 p-4 rounded-xl space-y-3 font-mono">
                  <div className="text-xs text-red-450 font-bold uppercase">
                    &gt; PURGE CONFIRMATION REQUIRED: This will clear localStorage entirely. Are you absolutely certain?
                  </div>
                  <div className="flex gap-2">
                    <button
                      onClick={handleWipeData}
                      className="py-2.5 px-4 rounded-lg text-xs font-bold bg-red-600 hover:bg-red-500 text-white uppercase cursor-pointer min-h-[44px] active:scale-[0.97]"
                    >
                      [CONFIRM PURGE]
                    </button>
                    <button
                      onClick={() => setShowConfirm(false)}
                      className="py-2.5 px-4 rounded-lg text-xs font-bold bg-charcoal-800 hover:bg-charcoal-700 text-slate-400 uppercase cursor-pointer min-h-[44px] active:scale-[0.97]"
                    >
                      [ABORT]
                    </button>
                  </div>
